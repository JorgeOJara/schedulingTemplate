...
router.get('/by-location/:locationId/employees', async (req: AuthRequest, res) => {
  try {
    const employees = await EmployeeGroupService.getEmployeesByLocation(
      req.user!.orgId,
...
router.put('/:id', async (req: AuthRequest, res) => {
  try {
    const group = await EmployeeGroupService.updateGroup(
      req.user!.orgId,
...
router.delete('/:id/members/:userId', async (req: AuthRequest, res) => {
  try {
    await EmployeeGroupService.removeMember(
      req.user!.orgId,
      String(req.params.id),
